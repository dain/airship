...
public class TestAssignmentResource
{
    ...
    {
        Response response = resource.assign(UUID.randomUUID(), UPGRADE);
    ...
    public void testAssignNullAssignment()
    {
        ...
        resource.assign(slotStatus.getId(), null);
    }
...
//    }
    ...
    {
        Response response = resource.assign(slotStatus.getId(), UPGRADE);
